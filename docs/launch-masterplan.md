...
Der laufende Import ersetzt keine Qualitätsstichprobe. Aktuelle Titel sind nur ein Teil des Katalogs: Die Prüfung vom 7. September 2026 bestätigte Lücken bei 4 Blocks, Dark, Inception, Breaking Bad und Interstellar. Diese fünf Titel wurden gezielt aus TMDB und der Streaming-API importiert; 4 Blocks ist in der öffentlichen Suche nachgewiesen. Der Bestand nach dieser Reparatur umfasst 4.700 Titel und ist weiterhin nicht vollständig.

Abgeschickte Titelsuchen ohne exakten Treffer erhalten eine priorisierte Nachsuche, auch wenn ähnliche lokale Treffer vorhanden sind. Die Oberfläche prüft den Auftragsstatus und aktualisiert neue Ergebnisse; Tagesbudgets oder technische Fehler werden als Verzögerung beziehungsweise Fehler angezeigt. Wiederholte automatische Anfragen werden je Suchbegriff, Sprache, Land und UTC-Tag begrenzt. Numerische Titel wie 1917 bleiben suchbar. Ein fortlaufender Kataloglauf übernimmt gespeicherte Cursor nach abgeschlossenen Importchargen und erschließt höchstens zwei neue Seiten je Land und Medientyp am Tag. Ein erreichtes Chargenlimit ist kein Beleg für einen vollständigen Katalog.

Täglich überwachen: erfolgreiche Aktualisierungen je Markt, alternde Datenstände, fehlerhafte Jobs, ungültige Anbieterlinks, leere Suchergebnisse und Budgetverbrauch. Der gebuchte API-Tarif umfasst 100.000 monatliche Requests. Die konfigurierte Tagesgrenze beträgt seit dieser Reparatur 3.000; mit 20 Prozent Sicherheitspuffer bleiben höchstens 2.400 Einheiten täglich und 80.000 monatlich. Davon hält die Anwendung täglich 100 Einheiten für abgeschickte Titelsuchen frei; der Hintergrundimport stoppt bei 2.300. Es wurde kein zusätzlicher Tarif gebucht. Seitenaufrufe lesen überwiegend den eigenen Katalog. Datenprüfung und Neuimport teilen sich weiterhin die atomar geprüften Grenzen.

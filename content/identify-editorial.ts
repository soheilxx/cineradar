...
const copy = {
  ...
  headline: l(
    ...
    'Find a film or TV show from its plot',
  ),
  introduction: l(
  ...
  privacyNotice: l(
    ...
    'Describe the film or show without names, contact details or other private information about yourself or others. Your description is sent for searching only when you submit it. Cineradar does not create a personal archive of these searches or send descriptions or transcripts to Google Analytics.',
  ),
...
const steps = [
  {
    ...
    body: l(
      ...
      'A distinctive scene, a character’s goal or an unusual setting helps more than “an exciting film”. If you can, add whether it was a film or a show and an approximate period.',
    ),
  },
  {
    title: l(
...
const faq = [
  {
    question: l(
      ...
      'How do I find a film when I have forgotten its name?',
    ),
    answer: l(
  ...
  },
  {
    question: l(
      ...
      'Can I find a TV show from a scene?',
    ),
    answer: l(
      ...
      'Yes. Choose TV show if you are sure. Recurring characters, the setting and the main storyline are useful clues. Not every individual episode or scene is described in the catalogue.',
    ),
  },
  {
    question: l(
  ...
  },
  {
    question: l(
      ...
      'Can Cineradar recognise audio from a film?',
    ),
    answer: l(
      ...
      'This feature uses your description. The microphone lets you dictate your memory as text; it does not identify film clips, soundtracks or uploaded videos.',
    ),
  },
  {
    question: l(
    ...
    answer: l(
      ...
      'A film or show’s identity does not depend on availability in your country. Rights and offers vary by market and over time. The title page shows the available checking status and lets you choose another streaming country.',
    ),
  },
];
const examples = [
